    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View style={styles.inner}>
        ...
        <Text style={styles.subtitle}>
          Envoyé au <Text style={styles.phone}>{phone}</Text>
        </Text>
        ...
        <View style={styles.resendRow}>
          <Text style={styles.resendLabel}>Tu n'as pas reçu le code ? </Text>
          {resendTimer > 0 ? (
        ...
        <TouchableOpacity
          style={[styles.btn, otp.some(d => !d) && styles.btnDisabled]}
